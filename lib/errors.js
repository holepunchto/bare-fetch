module.exports = class FetchError extends Error {
  ...
  static TOO_MANY_REDIRECTS (msg) {
    return new FetchError(msg, 'TOO_MANY_REDIRECTS', FetchError.TOO_MANY_REDIRECTS)
  }
  ...
  static BODY_ALREADY_CONSUMED (msg) {
    return new FetchError(msg, 'BODY_ALREADY_CONSUMED', FetchError.BODY_ALREADY_CONSUMED)
  }
}
